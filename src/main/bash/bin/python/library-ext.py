...
def help():
    print("")
    print("library-ext - extracts ADOC, BIB and Biblatec from library YAML sources\n")
    print("       Usage: library-ext [options]\n")
    print("       Options")
    ...
    print("\n")
    print("Extracted ADOC files will be written to the output directory, if set")
    print("Entry files for ADOC files will be created in the output directory")
    print("Extracted BiBTeX and Biblatex files will be written to the YAML source directory")
    print("\n")
...
def process_file(file):
    ...
    if file_exists == True:
        ...
        ##
        adoc_content = "//\n"
        adoc_content += "// This file was generated by SKB-Dashboard, task 'library-ext'\n"
